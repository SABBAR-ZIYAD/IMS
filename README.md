...
Backend Logic Mastery: Implement robust SQL handling and MVC separation.

Data Integrity: Prevent logical errors in stock calculations through transactional history.

Modern UX: Move away from "Gray Swing" interfaces using JavaFX and CSS styling.

Media Handling: Implement efficient file I/O for product image management.
...
🚀 Future Roadmap (Bonus Features)

[ ] PDF Export: Generate "Low Stock" reports or Invoices as downloadable PDFs.

[ ] Barcode Integration: Support for USB barcode scanner input.
